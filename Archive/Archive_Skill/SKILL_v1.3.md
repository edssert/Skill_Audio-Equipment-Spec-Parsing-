...
**Skill_Version: 1.3** (파일명 관례: SKILL_v1.3.md)
...
- **Phase 3**: 타 브랜드 교차 테스트 — 용어 매핑 사전을 확장 통합. 브랜드별 출처 우선순위 규칙도 이때 확장한다.
- **Phase 4**: 스키마 진화 — 새 속성 발견 시 기존 제품 .md 파일들에도 해당 키를 `null` 값으로 일괄 추가하여 리팩토링한다.
</phase_workflow>
