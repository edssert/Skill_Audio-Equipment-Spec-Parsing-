...
Schema_Version: 1.0 (Phase 3-1 신규 제품 파싱)
...
| Rated_Power_Per_Ch_BTL_8_Ohms | null | W |
| Rated_Power_Per_Ch_BTL_16_Ohms | null | W |
| Peak_Power_Per_Ch_BTL_8_Ohms | null | W |
| Peak_Power_Per_Ch_BTL_16_Ohms | null | W |
| Rated_Power_Per_Ch_PBTL_4_Ohms | null | W |
| Rated_Power_Per_Ch_PBTL_8_Ohms | null | W |
| Rated_Power_Per_Ch_PBTL_16_Ohms | null | W |
| Peak_Power_Per_Ch_PBTL_4_Ohms | null | W |
| Peak_Power_Per_Ch_PBTL_8_Ohms | null | W |
| Peak_Power_Per_Ch_PBTL_16_Ohms | null | W |
...
**[신규] 섹션 전체**: LA4X의 OM/AE 어디에도 이들 항목에 대응하는 스펙이 확인되지 않아 전량 null 유지.
...
이번 소스 집합에서 정의되지 않아 null 처리된 항목: Rated_Power_Per_Ch_2.7_Ohms, Rated_Power_Per_Ch_16_Ohms, Peak_Power_Per_Ch_4/8/16_Ohms, Total_Power_Capability, 브릿징 관련 8개 Key(비적용 확정), EQ_Filters_Per_Output, Amplifier_Power_Management(L-SMART 없음), Terminal_Block_Pinout(비적용), CACOM_Pinout, SC32_Channel_Mapping, Speaker_Output_Accessories, Service_Port_Type(비적용), Speaker_Terminal_Block_SE_BTL_Wiring(비적용), PBTL_Activation_Method(비적용), GPIO_Type, DSP_Backup_Power_Input(비적용 확정), Max_Operating_Altitude (LA4X 자체 근거 부족/비적용, 총 24건), d80_specific 12건, d90_specific 9건. 전체 45건. 확정적 비존재(0/No)로 명시한 항목은 Bridging_Support, AES67_Support, GPIO_Count, DSP_Backup_Power_Input, Redundancy_Type 등 5건이며 각각 전문 검색 근거를 각주에 명기했다.
