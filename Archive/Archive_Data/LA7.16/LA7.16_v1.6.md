...
Schema_Version: 1.6 (사용자 검토 반영 - DSP_Sampling_Rate/Latency 근거 보강: 상시 내장 SRC 및 "independent from input Fs" 확정 문구 명기, D80/D90과의 서술 비교. 기존 Value는 변경 없음)
