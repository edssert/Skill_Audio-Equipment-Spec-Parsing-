...
Schema_Version: 2.2 (Minor - 5D 신규 스키마 확장 양방향 동기화: input_dante 섹션 7개 Key + connectivity Fault_Contact_Type 1개 Key + 10D 신규 스키마 확장 양방향 동기화: control_monitoring Web_Remote_Interface 1개 Key 추가, 전부 null)
최종 작업 일시: 2026-07-16
...
| Web_Remote_Interface [신규][32] | null | - |
...
**[신규][32] Web_Remote_Interface**: 10D(d&b audiotechnik 차세대 설치용 라인) 파싱 중 발견된 신규 Key — 별도 소프트웨어(LA Network Manager) 없이 표준 웹 브라우저로 기기에 직접 접속하는 브라우저 기반 내장 웹 인터페이스 개념. LA7.16i의 기존 소스에는 이 개념에 대응하는 서술이 확인되지 않아 null(미확인)로 소급 반영한다.
