...
이번 파일에서 null 처리된 항목 (총 45건, D25 파싱 중 발견된 신규 Key Max_Output_Current_Peak 1건, 5D 파싱 중 발견된 신규 Key 8건(input_dante 7개 + Fault_Contact_Type) 및 10D 파싱 중 발견된 신규 Key 1건(Web_Remote_Interface) 소급 반영 포함):
