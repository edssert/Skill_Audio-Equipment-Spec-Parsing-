...
Schema_Version: 2.4 (재분류됨, 구 v5.1 - Phase 3-1 - bidirectional sync completed with LA7.16_v1.2: 1 additional key backfilled as null; no existing values changed)
