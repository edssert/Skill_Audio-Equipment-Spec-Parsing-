...
Schema_Version: 2.1 (5D 파싱 중 신설된 input_dante 섹션 및 Fault_Contact_Type Key의 양방향 스키마 동기화 반영 — null-only 추가, 실제 LA4X 데이터 변경 없음)
최종 작업 일시: 2026-07-16
...
이번 소스 집합에서 정의되지 않아 null 처리된 항목 (총 50건, v2.0의 42건에서 5D 파싱 중 발견된 신규 스키마 확장분 8건 — input_dante 섹션 7건 + Fault_Contact_Type 1건 — 소급 반영):
