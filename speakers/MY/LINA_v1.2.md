...
| Key | Value | Unit |
|---|---|---|
| Usable_Bandwidth_Hz [1] | 65 - 18000 (권장 동작 대역, dB 기준 미표기) | Hz |
...
| v1.1 to v1.2 | speakers 카테고리 전체 일괄 동기화 라운드(2026-07-18, d&b 대량 배치 완료 후) — 신규 Key `Frequency_Response_4dB_Hz`(미확인), `Peak_Power_Handling_10ms_Overall`(비적용), `Remote_Mute_Control`(750-LFC/900-LFC 유래, 미확인) 반영. Null Report 47건(미확인 37건+비적용 10건)으로 갱신. |
