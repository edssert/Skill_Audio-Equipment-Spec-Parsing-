...
**미확인(정보 부족)**: Model_Number, Compliance_Standards, WEEE_Marking, Usable_Bandwidth_Hz, Frequency_Response_6dB_Hz, Frequency_Response_3dB_Hz, Max_SPL_4x_Array_Far_Field_Scaled_1m, Max_SPL_Single_Module, AES75_Max_Linear_SPL, Nominal_Directivity_Vertical, DSP_Preset_Name, LF_Transducer, LF_Nominal_Impedance, MF_Nominal_Impedance, HF_Nominal_Impedance, Link_Connector, Faston_Pinout, Max_Enclosures_Per_Controller_Output, Max_Enclosures_Per_Controller_Total, Handles, Rigging_Components_Material, Finish_Color, preset_guide_and_matching(전 항목), delay_defaults(전 항목), mechanical_safety(전 항목), RMS_Power_Handling_LF, RMS_Power_Handling_MF, RMS_Power_Handling_HF — 30건.
**비적용(XSLi12-SVS 아키텍처상 개념 자체 불성립)**: Nominal_Impedance_Overall, RMS_Power_Handling_Overall — 2건.

**총계**: null 32건 (미확인 30건 + 비적용 2건). 확정적 비존재(0/No)로 명시한 항목은 0건. XSLi8-SVS와 총계까지 일치.
