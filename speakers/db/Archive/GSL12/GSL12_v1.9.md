...
**미확인(정보 부족)**: Nominal_Directivity_Vertical, Frequency_Response_6dB_Hz, Frequency_Response_3dB_Hz, AES75_Max_Linear_SPL, Max_Enclosures_Per_Controller_Total, LF_Acoustical_Load, RMS_Power_Handling_LF, RMS_Power_Handling_MF, RMS_Power_Handling_HF, Rigging_Components_Material, Finish_Color, IP_Rating, mechanical_safety(Safe_Limit 열 — 3개 Configuration 행의 null 셀, 3건; Safety_Factor, 1건) — 16건.
