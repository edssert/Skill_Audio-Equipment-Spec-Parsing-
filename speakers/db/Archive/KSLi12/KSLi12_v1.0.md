...
**비적용(KSLi12 아키텍처상 개념 자체 불성립)**: DSP_Preset_Name, LF_Transducer, LF_Nominal_Impedance, MF_Nominal_Impedance, HF_Nominal_Impedance, preset_guide_and_matching(전 항목), delay_defaults(전 항목) — 7건.

**총계**: null 20건 (미확인 13건 + 비적용 7건). 확정적 비존재(0/No)로 명시한 항목은 0건. KSLi8과 총계까지 일치.
