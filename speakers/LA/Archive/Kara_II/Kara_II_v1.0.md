...
**비적용**: CUT_Mode_Available, HFC_Function_Settings, Coupling_Function_Range, MF_Transducer, MF_Acoustical_Load, MF_Nominal_Impedance, RMS_Power_Handling_MF, PA_COM_Pinout_AB/CD/EF/GH, Terminal_Block_Pinout_1/2 — 11건.

**총계**: null 24건 (미확인 13건 + 비적용 11건). 확정적 비존재(0/No)로 명시한 항목은 1건 — Passive_Crossover_Network(No).
