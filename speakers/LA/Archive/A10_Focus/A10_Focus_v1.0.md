...
|---|---|---|---|
| [A10] or [A10_FI] or [A10_MO] + [KS21_100] | 0 | KS21 = 0 | null |
| [A10] or [A10_FI] + [KS21_100_C] | 5.5 | KS21 = 0 | null |
| [A10] or [A10_FI] + [KS21_100_Cx] | 0 | KS21 = 0 | null |

### 주석 및 출처 (Notes & Sources)

**출처**: A10_OM_EN.pdf p.50 "Pre-alignment delays". Polarity는 색상 아이콘 표기로 추정되나, 남은 제품 전체 조사 일정상 이 페이지는 이미지 렌더링을 수행하지 않아 null로 유지(딜레이 수치 자체는 텍스트로 확인된 실값).
...
**총계**: null 18건 (미확인 13건 + 비적용 5건). 확정적 비존재(0/No)로 명시한 항목은 0건.
