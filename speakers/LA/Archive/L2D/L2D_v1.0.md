...
**K1_Delay_ms 컬럼명**: 스키마 원 명칭을 그대로 유지 — 실제로는 "1차 엘리먼트(이 경우 L2D) 자신의 딜레이"를 의미.
